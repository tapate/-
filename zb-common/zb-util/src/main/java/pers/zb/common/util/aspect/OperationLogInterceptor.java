package pers.zb.common.util.aspect;
...
import pers.zb.common.util.annotation.SignInterceptor;
...
public class OperationLogInterceptor {
    ...
    @Pointcut("@annotation(pers.zb.common.util.annotation.SignInterceptor)") // 这个是拦截带有@SignInterceptor注解的方法
