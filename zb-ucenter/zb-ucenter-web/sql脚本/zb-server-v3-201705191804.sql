...
CREATE TABLE `leave_apply` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=58 DEFAULT CHARSET=utf8 COMMENT='OA请假申请表';
...
CREATE TABLE `sys_role_permission` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=859 DEFAULT CHARSET=utf8 COMMENT='角色权限表';

/*Data for the table `sys_role_permission` */

insert  into `sys_role_permission`(`id`,`role_id`,`permission_id`) values (226,3,-1),(227,3,1),(228,3,2),(688,5,-1),(689,5,28),(690,5,30),(691,5,32),(749,2,-1),(750,2,1),(751,2,2),(752,2,28),(753,2,29),(754,2,30),(755,2,31),(756,2,33),(757,2,34),(830,4,-1),(831,4,28),(832,4,30),(833,4,35),(834,1,-1),(835,1,1),(836,1,2),(837,1,9),(838,1,10),(839,1,11),(840,1,20),(841,1,3),(842,1,12),(843,1,14),(844,1,15),(845,1,16),(846,1,4),(847,1,13),(848,1,17),(849,1,18),(850,1,19),(851,1,21),(852,1,22),(853,1,23),(854,1,24),(855,1,26),(856,1,27),(857,1,28),(858,1,30);
...
insert  into `sys_user`(`id`,`user_name`,`password`,`real_name`,`status`,`open_id`,`create_time`,`update_time`) values (1,'admin','e10adc3949ba59abbe56e057f20f883e','超级管理员',0,NULL,'2016-08-03 13:22:46','2017-03-31 18:16:39'),(2,'yuangong01','e10adc3949ba59abbe56e057f20f883e','PM',0,NULL,'2017-03-31 18:13:27','2017-05-16 09:45:48'),(3,'bumenjingli','e10adc3949ba59abbe56e057f20f883e','部门经理',0,NULL,'2017-04-01 11:36:59','2017-04-01 11:36:59'),(5,'renshi','e10adc3949ba59abbe56e057f20f883e','人事A',0,NULL,'2017-05-19 14:34:32','2017-05-19 14:34:32'),(6,'renshi2','e10adc3949ba59abbe56e057f20f883e','人事B',0,NULL,'2017-05-19 15:20:50','2017-05-19 15:20:50');
...
insert  into `sys_user_role`(`id`,`user_id`,`role_id`) values (66,1,1),(67,2,2),(68,3,5),(74,5,4),(75,6,4);