...
<body>
<!-- 处理请假申请URL -->
<input type="hidden" name="deptLeaderAuditHandleUrl"  id="deptLeaderAuditHandleUrl" value="<c:url value="/oa/deptleader/audit/handle"/>"/>
    
<div style="width: 600px; height: 500px; padding: 15px; overflow: auto;">
    <form class="form-horizontal" id="deptLeaderAuditDetailForm">
        <!-- 任务ID -->
        ...
        <div class="form-group">
            ...
            <div class="col-xs-5">
                <div class="input-group">
                    <select class="form-control" name="deptleaderApproveResult" id="deptleaderApproveResult">
