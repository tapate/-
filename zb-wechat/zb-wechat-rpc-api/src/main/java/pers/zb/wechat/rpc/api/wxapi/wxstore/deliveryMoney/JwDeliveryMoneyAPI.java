package pers.zb.wechat.rpc.api.wxapi.wxstore.deliveryMoney;
...
public class JwDeliveryMoneyAPI {
    ...
    public static DeliveryMoneyRtnInfo doAddExpress(String newAccessToken, DeliveryMoney postage) {
        if (newAccessToken != null) {
            ...
            DeliveryMoneyRtnInfo postageRtnInfo = (DeliveryMoneyRtnInfo) JSONObject.toBean(result,
                    DeliveryMoneyRtnInfo.class);
