...
public class ApiGetAuthorizerRetAuthorizer {
    ...
    public void setService_type_info(ApiGetAuthorizerRetAuthorizerSType service_type_info) {
    ...
    public void setVerify_type_info(ApiGetAuthorizerRetAuthorizerVType verify_type_info) {
