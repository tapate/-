...
public class JwSendMessageAPITest {
    ...
    public void getToken() throws WexinReqException {
        ...
        String appscret = "c98c3487158d8432916b09495888b440";
    ...
    public void testSendMessageToGroupOrAllWithText() {
        ...
        try {
            ...
            group.setId("101");
            SendMessageResponse response = service.sendMessageToGroupOrAllWithText(newAccessToken, false, group,
                    "我的文本预览。。。");
    ...
    public void testGetReportBySendMessageReturnString() {
        String a = "" + "<xml>" + "<ToUserName><![CDATA[gh_3e8adccde292]]></ToUserName>"
                + "<FromUserName><![CDATA[oR5Gjjl_eiZoUpGozMo7dbBJ362A]]></FromUserName>"
                + "<CreateTime>1394524295</CreateTime>" + "<MsgType><![CDATA[event]]></MsgType>"
                + "<Event><![CDATA[MASSSENDJOBFINISH]]></Event>" + "<MsgID>1988</MsgID>"
                + "<Status><![CDATA[sendsuccess]]></Status>" + "<TotalCount>100</TotalCount>"
                + "<FilterCount>80</FilterCount>" + "<SentCount>75</SentCount>" + "<ErrorCount>5</ErrorCount>"
                + "</xml>";
        try {
